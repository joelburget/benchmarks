...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostFile.post_revision'
        db.add_column('posts_postfile', 'post_revision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['posts.PostRevision'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PostFile.post_revision'
        db.delete_column('posts_postfile', 'post_revision_id')
