...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('posts_post', 'sticky')


    def backwards(self, orm):
        
        # Adding field 'Post.sticky'
        db.add_column('posts_post', 'sticky', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
