...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('posts_postrevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['posts.PostFile'], null=True, blank=True)),
            ('published', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('previous', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['posts.PostRevision'])),
        ))
        db.send_create_signal('posts', ['PostRevision'])
        ...
        # Deleting field 'PostFile.post'
        db.delete_column('posts_postfile', 'post_id')


    def backwards(self, orm):
        
        # Deleting model 'PostRevision'
        db.delete_table('posts_postrevision')

        # Deleting field 'Post.file'
        db.delete_column('posts_post', 'file_id')

        # We cannot add back in field 'PostFile.post'
        raise RuntimeError(
            "Cannot reverse this migration. 'PostFile.post' and its values cannot be restored.")
    ...
    models = {
        ...
        'posts.post': {
            ...
            'file': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['posts.PostFile']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
