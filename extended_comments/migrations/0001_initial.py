...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExtendedComment'
        db.create_table('extended_comments_extendedcomment', (
            ('comment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['comments.Comment'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('extended_comments', ['ExtendedComment'])


    def backwards(self, orm):
        
        # Deleting model 'ExtendedComment'
        db.delete_table('extended_comments_extendedcomment')
